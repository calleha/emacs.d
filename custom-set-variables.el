(custom-set-variables
 ...
 '(package-selected-packages
   '(emms visual-fill-column org-present god-mode avy corfu vertico org-modern org-ai mini-modeline exwm-modeline zygospore sudo-edit vterm org-ref pdf-tools dmenu eglot yasnippet exwm-edit exwm gnuplot gnuplot-mode mc-extras multiple-cursors which-key xclip ##)))
